          ...
          <div className="flex flex-col items-center min-h-screen">
            ...
            <div ref={introductionRef} className="section-container">
              <div className="section-content">
                ...
                <p className="section-paragraph">
                  ...
                  management application uses searching and sorting algorithms
                  for quick and efficient data retrieval and organization.
                  Searching finds specific information, and sorting organizes
                  data for better accessibility. It is up to the programmer to
                  choose which algorithm to use depending on factors like data
                  size and structure.
                </p>
              </div>
            </div>
            ...
            <div ref={useCasesRef} className="section-container">
              <div className="section-content">
                ...
                <p className="section-paragraph">
                  Searching algorithms are very important in modern data
                  retrieval systems. In large-scale databases containing
                  millions of records, efficient searching makes the quality of
                  life much better for all users. These algorithms are used in
                  everything from online shopping searches to research
                  databases, letting users locate specific information in large
                  datasets quickly. The choice between sequential and binary
                  search often depends on whether the data is sorted, with
                  binary search offering dramatically faster results for
                  organized datasets.
                </p>

                <p className="section-paragraph">
                  Sorting algorithms do much more than simply organize data.
                  Their job seems simply, but they actually have much bigger
                  impacts such as allowing for efficient data processing. By
                  arranging information in a logical order, they also make it
                  easier for searching algorithms to do their job.
                </p>
              </div>
            </div>
            ...
            <div ref={searchingRef} className="section-container">
              <div className="section-content">
                ...
                <p className="section-paragraph">
                  Sequential search checks through each element in order until
                  the corresponding target is found. It runs in O(n) time
...
public int SequentialSearch(String[] fruits, String targetBananaType) {
    ...
    return -1; // Banana not found
                ...
                <p className="section-paragraph">
                  ...
                  the array in half to lessen the search range and more
                  efficiently search for the target than sequential search.
                </p>
                <p className="section-paragraph">
...
`}</code>
            ...
            <div ref={sortingRef} className="section-container">
              <div className="section-content">
                ...
                <p className="section-paragraph">
                  ...
                  part and swaps it with the first unsorted element, thus making
                  that element also part of the sorted array. Selection sort is
                ...
                <p className="section-paragraph">
                  ...
                  data set to assume that the first one has been sorted. Then,
                  it compares it with the previous element, shifting itself to
                  the left one if it's smaller than the previous (or larger).
                </p>
                <p className="section-paragraph">
                ...
                <p className="section-paragraph">
                  ...
                  It first selects a pivot element and partitions the array
                  around it. Then, it rearranges the elements so that the
                  elements smaller than the pivot are to the left and elements
                  larger than the pivot are to the right. It is oftentimes
                  considered the fastest sorting algorithm to be developed to
                  this day. However, quick sort is not a stable sorting
                  algorithm.
                </p>
                <p className="section-paragraph">
            ...
            <div ref={mistakesRef} className="section-container">
              <div className="section-content">
                ...
                <p className="section-paragraph">
                  It's common to forget that not all sorting algorithms are
                  stable sorting algorithms. Quicksort and Selection Sort are
                  not stable, so keep that in mind when deciding which algorithm
                  to use.
                </p>
                ...
                <p className="section-paragraph">
                  Sometimes, you might forget which sorting algorithm is
                  necessary for what kind of datasets you're working with. For
                  larger datasets, it's better to use sorting algorithms that
                  run on O(n log n) time complexity since they handle larger
                  datasets at the same speed as smaller ones. However, they
                  might not be necessary for smaller datasets as complexity to
                  code is something to consider.
                </p>
              </div>
            </div>

          ...
          >
            <div className="w-[60vh] text-white">
              ...
              <p className="text-sm text-gray-300 leading-relaxed mb-6">
                ...
                basic concepts of classes and objects, OOP 2 introduces
                inheritance and expands on relationships between classes, OOP 3
                teaches complex mechanics that allow for more control over
                object behavior, inheritance, and polymorphism.
              </p>
            </div>
          </div>
          ...
          >
            <div className="w-[60vh] text-white">
              ...
              <p className="text-sm text-gray-300 leading-relaxed mb-6">
                ...
                assign it to a reference variable of type Aircraft. Polymorphism
                allows for code flexibility and reusability. Even though it
          ...
          <div ref={abstractRef} className="bg-[#121212] rounded-lg p-5 mb-5">
            <div className="w-[60vh] text-white">
              ...
              <p className="text-sm text-gray-300 leading-relaxed mb-6">
                ...
                with the abstract keyword. Abstract classes are used when you
                want to share code with classes that are closely related with
                each other. This is because similarly related subclasses need
          ...
          <div ref={interfacesRef} className="bg-[#121212] rounded-lg p-5 mb-5">
            <div className="w-[60vh] text-white">
              ...
              <p className="text-sm text-gray-300 leading-relaxed mb-6">
                ...
                overridden inside the class to customize the method’s behaviors.
                Interfaces are used when you want to define methods without
                actually implementing them yet. They can also be used when
              ...
              <div className="overflow-x-auto">
                <table className="min-w-full border border-gray-700">
                  ...
                  <tbody>
                    ...
                    {/* Row 5 */}
                    <tr className="border-b border-gray-700">
                      <th className="px-4 py-2 text-left">Access modifiers</th>
            ...
            <div className="w-[60vh] text-white">
              ...
              <ul className="list-disc pl-5 space-y-2 text-sm text-gray-300">
                <li>
                  ...
                  >
                    Inheritance, Interfaces, and Polymorphism Teaching Material
                  </a>
                </li>

          ...
          <div ref={oneDArraysRef} className="section-container">
            <div className="section-content">
              ...
              <p className="section-paragraph">
                ...
                immediately followed by square brackets, then the array's name
              ...
              <p className="section-paragraph">
                ...
                system starts at 0. So the "first" element in an array would be
                at index 0.
              </p>
          ...
          <div ref={twoDArraysRef} className="section-container">
            <div className="section-content">
              ...
              <p className="section-paragraph">
                ...
                Each array inside the 2D array serves as each row. Each index of
              ...
              <p className="section-paragraph">
                ...
                comes after the assignment operator should be "new [type of
                array][][]". Notice how there are two sets of square brackets
                being used for 2D arrays. The first set represents the number of
                arrays inside the 2D array, also known as the number of rows.
                The second set represents the number of indexes in each
                subsequent row, also known as the number of columns in the 2D
                array.
              </p>
